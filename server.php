<?php 
 ...
 // Welcome message
			header('location: http://localhost/registration/main.php');
		}
	}
}
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			if (mysqli_num_rows($results) == 1) {
				...
				header('location: http://localhost/registration/main.php'); //page on which the user is sent to after logging in
			}else {
